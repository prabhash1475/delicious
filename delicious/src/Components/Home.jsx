...
const innews = [
...

  {
    ...
    "image":"https://d2407na1z3fc0t.cloudfront.net/inTheNews/36/inthenews_62aadf6e2cbb7"
  },
  {
    "id":303,
...

  {
    ...
    "image":"https://d2407na1z3fc0t.cloudfront.net/inTheNews/40/inthenews_62aae21e9a38e"
  },

  {
    "id":307,
    "title":"Licious wants you to eat more meat",
    "image":"https://d2407na1z3fc0t.cloudfront.net/inTheNews/42/inthenews_62aae2a6d9bc4"
  },
  {
    "id":308,
    "title":"Licious pledges to be ESG compliant in the next 12 months",
    "image":"https://d2407na1z3fc0t.cloudfront.net/inTheNews/43/inthenews_62aae2dadd8aa"
  },
  {
    "id":309,
    "title":"Licious founders on building a unicorn startup based on what the consumer wants",
  ...
  },
  {
    ...
    "image":"https://d2407na1z3fc0t.cloudfront.net/inTheNews/44/inthenews_62aae32108c39"
  },
  {
    "id":311,
    "title":"Faster Chef Treats  Uninvited Friends With Licious",
    "image":"https://d2407na1z3fc0t.cloudfront.net/inTheNews/45/inthenews_62aae4c4d8331"
  },
]
...
<Popover >
  <PopoverTrigger>
  <Button colorScheme='none' variant='solid' ><Img
          src="https://www.licious.in/img/rebranding/banner/side.png"
          width={"100px"}
        /></Button>
  </PopoverTrigger>
  <PopoverContent border='0' bg='rgba(68,66,66,.93)' h='135px' position='fixed' left='25px' right='25px' bottom='30px' zIndex={104} >
    ...
    <PopoverBody >
      ...
      <Input isRequire='true' type='email' placeholder="Enter your Email" />
      <Button
      onClick={() =>
        toast({
...
<Container
      ...
      >
          ...
          <Carousel cols={3} rows={1} gap={10} h='500px' bg='red' >
      ...
      >
          ...
          {innews.map((product) => (
            <Carousel.Item>
                ...
                <Box>
                  <Box display='flex' alignItems='center' w='221px' h='160px' shadow='md' borderRadius='6px' bg='#fff'>
                  <Image w='100%' h='120px' src={product.image}   />
                  </Box>
                  
                  <Text color='#4a4a4a' lineHeight='19px' mt='8px' fontWeight='600' fontSize='16px' noOfLines={2} >
                    {product.title}
                  </Text>
                  </Box>
